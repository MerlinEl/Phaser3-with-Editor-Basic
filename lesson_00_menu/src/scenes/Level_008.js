...
class Level_008 extends Phaser.Scene {
	...
	editorCreate() {
		...
		text_1_1_1_1_1.text = "NinePatch Plugin";
		...
		// ninepatch
		const ninepatch = this.add.ninePatch(70, 219, 200, 100, "cage_01");
		ninepatch.setOrigin(0, 0);

		// ninepatch_1
		const ninepatch_1 = this.add.ninePatch(338, 217, 400, 100, "cage_01");
		ninepatch_1.setOrigin(0, 0);

		// ninepatch_1_1
		const ninepatch_1_1 = this.add.ninePatch(67, 358, 400, 50, "cage_01");
		ninepatch_1_1.setOrigin(0, 0);

		// ninepatch_2
		const ninepatch_2 = this.add.ninePatch(79, 445, 200, 100, "card_01");
		ninepatch_2.setOrigin(0, 0);

		// ninepatch_2_1
		const ninepatch_2_1 = this.add.ninePatch(309, 446, 80, 100, "card_01");
		ninepatch_2_1.setOrigin(0, 0);

		// ninepatch_2_1_1
		const ninepatch_2_1_1 = this.add.ninePatch(411, 445, 80, 60, "card_01");
		ninepatch_2_1_1.setOrigin(0, 0);

		// ninepatch_2_1_1_1
		const ninepatch_2_1_1_1 = this.add.ninePatch(82, 598, 800, 60, "card_01");
		ninepatch_2_1_1_1.setOrigin(0, 0);

		// ninepatch_1_1_1
		const ninepatch_1_1_1 = this.add.ninePatch(531, 285, 400, 400, "cage_01");
		ninepatch_1_1_1.setOrigin(0, 0);
		...
		const ninepatchComponentBase = new ComponentBase(ninepatch);
		ninepatchComponentBase.instanceName = "frame_01";
		ninepatchComponentBase.colorize = true;
		ninepatchComponentBase.hexColor = "0xff7b80";

		// ninepatch_1 (components)
		const ninepatch_1ComponentBase = new ComponentBase(ninepatch_1);
		ninepatch_1ComponentBase.instanceName = "frame_02";
		ninepatch_1ComponentBase.colorize = true;
		ninepatch_1ComponentBase.hexColor = "0x91ff39";

		// ninepatch_1_1 (components)
		const ninepatch_1_1ComponentBase = new ComponentBase(ninepatch_1_1);
		ninepatch_1_1ComponentBase.instanceName = "frame_03";
		ninepatch_1_1ComponentBase.colorize = true;
		ninepatch_1_1ComponentBase.hexColor = "0x0095cb";

		// ninepatch_2 (components)
		const ninepatch_2ComponentBase = new ComponentBase(ninepatch_2);
		ninepatch_2ComponentBase.instanceName = "bg_01";
		ninepatch_2ComponentBase.colorize = true;
		ninepatch_2ComponentBase.hexColor = "0x8444f6";

		// ninepatch_2_1 (components)
		const ninepatch_2_1ComponentBase = new ComponentBase(ninepatch_2_1);
		ninepatch_2_1ComponentBase.instanceName = "bg_02";
		ninepatch_2_1ComponentBase.colorize = true;
		ninepatch_2_1ComponentBase.hexColor = "0xffffff";

		// ninepatch_2_1_1 (components)
		const ninepatch_2_1_1ComponentBase = new ComponentBase(ninepatch_2_1_1);
		ninepatch_2_1_1ComponentBase.instanceName = "bg_03";
		ninepatch_2_1_1ComponentBase.colorize = true;
		ninepatch_2_1_1ComponentBase.hexColor = "0xcc6266";

		// ninepatch_2_1_1_1 (components)
		const ninepatch_2_1_1_1ComponentBase = new ComponentBase(ninepatch_2_1_1_1);
		ninepatch_2_1_1_1ComponentBase.instanceName = "bg_04";
		ninepatch_2_1_1_1ComponentBase.colorize = true;
		ninepatch_2_1_1_1ComponentBase.hexColor = "0x73cc2d";

		// ninepatch_1_1_1 (components)
		const ninepatch_1_1_1ComponentBase = new ComponentBase(ninepatch_1_1_1);
		ninepatch_1_1_1ComponentBase.instanceName = "frame_04";
		ninepatch_1_1_1ComponentBase.colorize = true;
		ninepatch_1_1_1ComponentBase.hexColor = "0x00bbff";
