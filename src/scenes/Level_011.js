...
class Level_011 extends Phaser.Scene {
	...
	editorCreate() {
		...
		text_1_1_1_1_1.text = "Particle - Shine Explosion";
		...
		// bonus_01
		const bonus_01 = new Bonus_01(this, 503, 394);
		...
		btn_01ClickButton.actionName = "show-shine-explosion";
	...
	create() {
		...
		this.bonusFlare = new FocusFlare(this.bonus_01);
	...
	buttonActionClicked(go, action){
        ...
        switch (action){
			...
			case "show-shine-explosion":
				Ctrace("Level > buttonActionClicked > button:{0} action{1}", go.instanceName, action);
				this.bonus_01.playEffect(2000); // glow and fade
				this.bonusFlare.emitParticleAt(this.bonus_01);
			break;
		}
    }
	/* END-USER-CODE */
