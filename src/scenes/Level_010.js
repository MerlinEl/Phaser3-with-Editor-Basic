...
class Level_010 extends Phaser.Scene {
	...
	editorCreate() {
		...
		text_1_1_1_1_1.text = "Bonus Animation - Path Editor 1";
		...
		// ct_dot_01
		const ct_dot_01 = new Dot(this, 762, 319);
		layer_all_dots.add(ct_dot_01);

		// ct_dot_02
		const ct_dot_02 = new Dot(this, 635, 408);
		layer_all_dots.add(ct_dot_02);

		// ct_dot_03
		const ct_dot_03 = new Dot(this, 444, 245);
		layer_all_dots.add(ct_dot_03);

		// ct_dot_04
		const ct_dot_04 = new Dot(this, 196, 379);
		layer_all_dots.add(ct_dot_04);

		// ct_dot_05
		const ct_dot_05 = new Dot(this, 477, 519);
		layer_all_dots.add(ct_dot_05);

		// star_01
		const star_01 = this.add.image(809, 133, "star_01");
		star_01.scaleX = 0.5;
		star_01.scaleY = 0.5;

		// btn_01
		const btn_01 = this.add.container(807, 672);
		...
		// btn_02
		const btn_02 = this.add.container(617, 672);
		...
		// btn_03
		const btn_03 = this.add.container(427, 672);
		...
		// btn_04
		const btn_04 = this.add.container(237, 672);
		...
		// ct_dot_01 (components)
		const ct_dot_01ComponentBase = new ComponentBase(ct_dot_01);
		ct_dot_01ComponentBase.instanceName = "dot_01";
		ct_dot_01ComponentBase.componentType = "Container";
		new DragAndDrop(ct_dot_01);

		// ct_dot_02 (components)
		const ct_dot_02ComponentBase = new ComponentBase(ct_dot_02);
		ct_dot_02ComponentBase.instanceName = "dot_02";
		ct_dot_02ComponentBase.componentType = "Container";
		new DragAndDrop(ct_dot_02);

		// ct_dot_03 (components)
		const ct_dot_03ComponentBase = new ComponentBase(ct_dot_03);
		ct_dot_03ComponentBase.instanceName = "dot_03";
		ct_dot_03ComponentBase.componentType = "Container";
		new DragAndDrop(ct_dot_03);

		// ct_dot_04 (components)
		const ct_dot_04ComponentBase = new ComponentBase(ct_dot_04);
		ct_dot_04ComponentBase.instanceName = "dot_04";
		ct_dot_04ComponentBase.componentType = "Container";
		new DragAndDrop(ct_dot_04);

		// ct_dot_05 (components)
		const ct_dot_05ComponentBase = new ComponentBase(ct_dot_05);
		ct_dot_05ComponentBase.instanceName = "dot_05";
		ct_dot_05ComponentBase.componentType = "Container";
		new DragAndDrop(ct_dot_05);
	...
	create() {
		...
		Ctrace("InteractiveSpline > dots:{0}", this.layer_all_dots.list.length);
		...
		SceneManager.activeSpline = new PointSpline_01(this, this.layer_all_dots.list, this.star_01);
