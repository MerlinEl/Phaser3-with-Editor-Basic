(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.outlinedotspipelineplugin = factory());
    ...
    var OutlineDotsPostFxPipeline = /*#__PURE__*/function (_PostFXPipeline) {
      _inherits(OutlineDotsPostFxPipeline, _PostFXPipeline);
  
      var _super = _createSuper(OutlineDotsPostFxPipeline);
  
      function OutlineDotsPostFxPipeline(game) {
        var _this;
  
        _classCallCheck(this, OutlineDotsPostFxPipeline);
  
        _this = _super.call(this, {
          name: 'rexOutlineDotsPostFx',
          game: game,
          renderTarget: true,
          fragShader: FragSrc
        });
      ...
      _createClass(OutlineDotsPostFxPipeline, [{
        key: "resetFromJSON",
        value: function resetFromJSON(o) {
          this.setThickness(GetValue$1(o, 'thickness', 3));
          this.setLevels(GetValue$1(o, 'levels', 4));
          this.setOutlineDotsColor(GetValue$1(o, 'outlineColor', 0xffffff));
          return this;
        }
      }, {
        key: "onPreRender",
        ...
        key: "setOutlineDotsColor",
        value: function setOutlineDotsColor(value) {
      ...
      return OutlineDotsPostFxPipeline;
    }(PostFXPipeline);
    ...
    var OutlineDotsPipelinePlugin = /*#__PURE__*/function (_BasePostFxPipelinePl) {
      _inherits(OutlineDotsPipelinePlugin, _BasePostFxPipelinePl);
  
      var _super = _createSuper(OutlineDotsPipelinePlugin);
  
      function OutlineDotsPipelinePlugin(pluginManager) {
        var _this;
  
        _classCallCheck(this, OutlineDotsPipelinePlugin);
  
        _this = _super.call(this, pluginManager);
  
        _this.setPostPipelineClass(OutlineDotsPostFxPipeline, 'rexOutlineDotsPostFx');
  
        return _this;
      }
  
      _createClass(OutlineDotsPipelinePlugin, [{
        key: "add",
        value: function add(gameObject, config) {
          this.setQuality(GetValue(config, 'quality', this.quality));
          return _get(_getPrototypeOf(OutlineDotsPipelinePlugin.prototype), "add", this).call(this, gameObject, config);
        }
      }, {
        key: "setQuality",
        value: function setQuality(value) {
          OutlineDotsPostFxPipeline.setQuality(value);
          return this;
        }
      }, {
        key: "quality",
        get: function get() {
          return OutlineDotsPostFxPipeline.getQuality();
        },
        set: function set(value) {
      ...
      return OutlineDotsPipelinePlugin;
    }(BasePostFxPipelinePlugin);
  
    SetValue(window, 'RexPlugins.Pipelines.OutlineDotsPostFx', OutlineDotsPostFxPipeline);
